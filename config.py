...
def get_arguments():
    ...
    parser.add_argument('--Gsteps', type=int, help='Generator inner steps', default=3)  # 用于生成器的训练，内部步数？
    parser.add_argument('--Dsteps', type=int, help='Discriminator inner steps', default=3)  # 用于判别器的训练，内部步数？
